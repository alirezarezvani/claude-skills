...
description: "When the user wants product marketing work: positioning, GTM planning, ICP definition, target-audience sharpening, competitive battlecards, launch playbooks, or sales enablement. Triggers include \"product marketing,\" \"PMM,\" \"positioning,\" \"GTM strategy,\" \"go-to-market,\" \"competitive analysis,\" \"competitive battlecard,\" \"ICP,\" \"target audience,\" \"market segmentation,\" \"April Dunford positioning,\" \"category creation,\" \"sales enablement,\" \"narrative strategy.\" Covers April Dunford positioning frameworks, JTBD interviews, battlecards, launch playbooks, and international entry. Distinct from launch-strategy (which executes a specific launch) and marketing-demand-acquisition (which executes paid channels). Critical for Mo: Mo Inc investor positioning (psychology-first vertical-AI with operator-as-first-customer moat, NOT horizontal-AI wrapper, NOT CRM, NOT automation, see locked product framing rule); askminimo PMM (compliance-built-in vs generic ChatGPT-for-agents; calm-guide tone vs hype); Curb PMM (homeowner home-prep app, consumer iOS, brand-isolated from Momentus, NO Texas/DFW context); Maureen Personal positioning (founder-broker-builder triangle, singular-receipts rule, lead with intention not numbers); Mo platform vs lofty / dotloop / Compass, read the Wacksman macro context before public positioning moves. Pair with marketing-skills:competitor-alternatives for vs pages. Pair with mo identity skill for Mo Inc voice. Pair with maureen-personal-brand for founder essays."
triggers:
  - product marketing
  - PMM
  - positioning
