...
description: "When the user wants to plan a product launch, feature announcement, beta opening, or release strategy. Triggers include \"launch,\" \"product launch,\" \"Product Hunt,\" \"feature release,\" \"announcement,\" \"go-to-market,\" \"GTM plan,\" \"beta launch,\" \"early access,\" \"waitlist,\" \"product update,\" \"launch checklist,\" \"launch momentum,\" \"founding cohort launch,\" \"App Store launch.\" Covers phased launches, channel strategy, launch-day playbooks, and ongoing momentum after launch day. Critical for Mo: askminimo public launch (live, ongoing demand-gen), Curb v1.4 launch + Curb Android Google Play launch (queued), Mo platform Christie Cannon beta-cohort launch (10 broker-owners cap, founder-tier 24-month lock), Maureen Personal Door 01 founding-cohort launch (capped at 10), Mo Inc investor raise launch sequence (deck send + warm-intro cascade after Mat reply). Distinct from marketing-strategy-pmm (positioning + ICP) and cold-email (prospecting outreach). Pair with marketing-skills:social-content for launch posts. Pair with marketing-skills:cold-email for warm-network launch outreach. Pair with marketing-skills:email-sequence for launch-day drips. Voice gates: brand voice skill always loads first."
license: MIT
metadata:
  version: 1.0.0
