...
| [**X Twitter Scraper**](https://github.com/Xquik-dev/x-twitter-scraper) | X API & Twitter scraper skill for AI coding agents — 40+ tools: tweet search, user lookup, follower extraction, engagement metrics, giveaway draws, trending topics, write actions, Telegram integrations. Works with Claude Code, Cursor, Codex, Copilot, Windsurf & 40+ agents |
