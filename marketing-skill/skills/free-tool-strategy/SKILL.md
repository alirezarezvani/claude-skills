...
description: "When the user wants to build a free interactive tool as a marketing engine: lead generation, SEO link bait, brand authority, or top-of-funnel acquisition. Triggers include \"engineering as marketing,\" \"free tool,\" \"calculator,\" \"generator,\" \"checker,\" \"grader,\" \"marketing tool,\" \"lead gen tool,\" \"build something for traffic,\" \"interactive tool,\" \"free resource,\" \"viral tool,\" \"home grader,\" \"score generator.\" Covers idea evaluation, scope sizing, distribution strategy, and post-launch conversion-to-paid. For pure SEO content (no tool), use seo-audit or content-strategy instead. Critical for Mo: Curb home readiness score IS Mo's flagship free-tool play (consumer iOS, 27.5% PV-to-DL conversion proves the funnel works at the top, leak is at paywall not at tool); askminimo \"try MiniMo for 5 minutes\" surface (free preview to agents before $19.99/mo upgrade); Momentus DFW homebuyer affordability calculator queued; Maureen Personal \"operator readiness assessment\" possible Door 01 top-of-funnel; Mo Inc moaihq.com \"is your brokerage ready for AI\" possibility. Pair with marketing-skills:paywall-upgrade-cro for free-to-paid conversion. Pair with product-skills:landing-page-generator for tool landing pages."
license: MIT
metadata:
  version: 1.0.0
