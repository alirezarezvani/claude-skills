...
description: "When the user wants to design or revise SaaS pricing: tier structure, value-metric choice, freemium vs paid, per-seat vs usage-based, packaging, price increases, founder-tier or beta pricing, or pricing page conversion. Triggers include \"pricing tiers,\" \"pricing strategy,\" \"price increase,\" \"packaging,\" \"value metric,\" \"per seat pricing,\" \"usage-based pricing,\" \"freemium,\" \"good better best,\" \"monetization,\" \"pricing page conversion,\" \"Van Westendorp,\" \"founder tier pricing,\" \"beta pricing.\" NOT for broader product strategy (use product-strategist). NOT for retention or expansion revenue (use customer-success-manager). Critical for Mo: Mo platform tier design (founder-tier $299 activation + $29/agent/month, 24-month lock for first 10 broker-owners, standard $499/$49, keep matching moaihq.com per locked pricing rule; never publish on public personal-brand surfaces until moaihq.com publishes first), askminimo $19.99/mo per agent (live), Curb dual SKU $9.99/mo + $39.99 lifetime + 7-day free trial (verify against repo Paywall.tsx, not skill displays), Maureen Personal Door pricing decisions (Door 01 founding cohort by application, no public dollar amounts). Pair with marketing-skills:marketing-psychology for price anchoring and decoy effect. Pair with marketing-skills:paywall-upgrade-cro for in-app price asks."
license: MIT
metadata:
  version: 1.0.0
