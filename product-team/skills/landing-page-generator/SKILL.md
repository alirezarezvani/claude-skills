...
description: "When the user wants to scaffold a landing page from scratch: Next.js TSX components, Tailwind layout, hero section, features grid, pricing block, testimonials, FAQ, CTA, or full-page generation. Triggers include \"landing page generator,\" \"build a landing page,\" \"new landing page,\" \"page scaffold,\" \"Next.js landing page,\" \"TSX landing page,\" \"hero section,\" \"pricing page scaffold,\" \"sales page,\" \"product landing.\" Critical for Mo: Maureen Personal Door 01 / Door 02 / Door 03 sales pages, Mo platform marketing site (post-Carlos call), askminimo agent acquisition pages, Curb feature deep-dive landing pages, Momentus custom website kickoff (Sanity CMS + Next.js stack approved). Pair with frontend-design skill for visual polish. Pair with marketing-skills:copywriting for headline and CTA copy. Pair with marketing-skills:page-cro for conversion optimization."
---
