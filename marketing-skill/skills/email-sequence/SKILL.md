---
name: "email-sequence"
description: "When the user wants to create or optimize a lifecycle email sequence: welcome drip, onboarding sequence, nurture sequence, post-purchase sequence, re-engagement sequence, win-back, trial-to-paid drip, or any automated email flow to subscribers who opted in. Triggers include \"email sequence,\" \"drip campaign,\" \"nurture sequence,\" \"onboarding emails,\" \"welcome sequence,\" \"re-engagement emails,\" \"email automation,\" \"lifecycle emails,\" \"post-purchase email,\" \"trial expiration email,\" \"win-back email.\" Distinct from cold-email (unsolicited prospecting to non-subscribers). For in-app onboarding, see onboarding-cro. Critical for Mo: askminimo agent welcome + activation sequence (MailerLite, $19.99/mo lifecycle), Momentus Ready or Not? post-booking drip + post-session nurture, Curb post-trial + post-purchase + Apple-renewal-failure flows, Maureen Personal Door 01 founding cohort nurture (founder-led), Mo platform broker onboarding sequence (post-Christie). Pair with marketing-skills:churn-prevention for win-back. Pair with marketing-skills:copywriting for subject lines and body copy. Voice gates: momentus-voice-updated-skill, curb-app-builder, maureen-personal-brand, mo."
license: MIT
metadata:
  version: 1.0.0
