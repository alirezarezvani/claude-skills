---
name: "demo-video"
description: "Use when the user asks to create a demo video, product walkthrough, feature showcase, animated presentation, marketing video, product teaser, GIF, or any visual content from screenshots and scene descriptions. Orchestrates playwright, ffmpeg, and edge-tts MCPs to produce polished videos with story arc, pacing, and visual hierarchy."
---
