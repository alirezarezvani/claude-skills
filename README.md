...
| **📣 Marketing** | 46 | 8 pods: Content (8), SEO + AEO (6 incl. ✨v2.7.3 `aeo` — E-E-A-T audit, citation tracking across 5 LLMs), CRO (6), Channels (6), Growth (4), Intelligence (4), Sales (2) + context foundation + orchestration router. 58 Python tools. Includes `social-publishing` (SocialClaw — publish to 13 platforms via API). | [marketing-skill/](marketing-skill/) |
