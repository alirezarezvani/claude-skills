---
name: "demo-video"
description: "Use when the user asks to create a demo video, product walkthrough, feature showcase, animated presentation, marketing video, product teaser, GIF, or launch video. Orchestrates playwright, ffmpeg, and edge-tts MCPs to produce polished videos from screenshots and scene descriptions with story arc, pacing, and visual hierarchy."
---
