...
Run scripts/cost_analyzer.py against your logs to get the breakdown.
...
Remove filler without losing meaning. Use scripts/prompt_compressor.py to audit prompt token efficiency.
