...
| [**Claude Code SDK**](https://github.com/SeifBenayed/claude-code-sdk) | Open-source, provider-agnostic SDK (JS, Python, Go, Rust) that runs Claude Skills on any LLM backend — zero dependencies |
| Project | Description |
|---------|-------------|
