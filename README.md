...
[![Commands](https://img.shields.io/badge/Commands-119-orange?style=for-the-badge)](#commands)
...
- **Python tools** — 666 CLI scripts (all stdlib-only, zero pip installs)
- **Reference docs** — 749 templates, checklists, and domain-specific knowledge files

**One repo, thirteen platforms.** Works natively as Claude Code plugins, Codex agent skills, Gemini CLI skills, Hermes Agent skills, Mistral Vibe skills, and converts to more tools via `scripts/convert.sh`. All 666 Python tools run anywhere Python runs.
