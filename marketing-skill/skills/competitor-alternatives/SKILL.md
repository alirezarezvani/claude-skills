...
description: "When the user wants to create competitor comparison or alternative pages for SEO and sales enablement: singular alternative, plural alternatives, you-vs-competitor, or competitor-vs-competitor formats. Triggers include \"alternative page,\" \"vs page,\" \"competitor comparison,\" \"comparison page,\" \"[Product] vs [Product],\" \"[Product] alternative,\" \"competitive landing pages,\" \"switch from competitor,\" \"comparison content,\" \"battlecard,\" \"competitive positioning page.\" Emphasizes deep research, modular content architecture, and varied section types beyond feature tables (decision-framework matrices, ICP-fit grids, migration guides). Critical for Mo: Mo platform positioning vs horizontal AI (ChatGPT, Claude, Gemini, Copilot) and vs vertical real-estate-adjacent SaaS (CRM-only tools like FUB, automation-only tools, generic LLM wrappers). The locked frame is psychology-first matching, NOT CRM or automation per the 2026-05-14 product framing rule; askminimo vs ChatGPT-for-agents framing (compliance built in vs raw LLM); Curb vs Zillow / Redfin home-prep editorial (consumer iOS, brand-isolated from Momentus). Brand-protection rule: do NOT publish competitor-named pages without Mo + legal review; comparison content is heavy on legal surface. Pair with marketing-skills:marketing-strategy-pmm for positioning. Pair with marketing-skills:copywriting for headline + CTA voice. Pair with brand voice skill always."
license: MIT
metadata:
  version: 1.0.0
