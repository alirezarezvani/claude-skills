...
- **SKILL.md is a full 6/6 PASS** on the write-a-skill checklist (binding for
  post-v2.6.0 skills). **Counters:** skills 362 → 363; tools 644 → 648; refs
  741 → 745; agents 102 → 103; commands 116 → 118; plugins 88 → 89 (verified via
