...
Run scripts/prompt_registry_manager.py to initialize and manage a file-based registry.
...
Run scripts/eval_runner.py to execute evals against a prompt version and golden dataset.
